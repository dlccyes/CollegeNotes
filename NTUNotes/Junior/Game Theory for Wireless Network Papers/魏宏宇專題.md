...
use [[Game Theory]] to solve resource allocation problem in wireless networking systems
...
- a user's utility
	- if choose to use edge server
		- $u=\alpha ((L_c+T)-(L_e+kT))-\frac{C}{k}$
		- $k$ = how many users in this coalition i.e. use the same container
